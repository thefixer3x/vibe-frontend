...
export default function MCPTestStandalonePage() {
  ...
  return (
    <div className="max-w-7xl mx-auto p-6">
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold">MCP Integration Test (Standalone)</h1>
          <p className="text-gray-600 mt-2">Test Model Context Protocol integration across the platform</p>
          <p className="text-sm text-gray-500 mt-1">This page bypasses authentication for testing purposes</p>
        </div>
